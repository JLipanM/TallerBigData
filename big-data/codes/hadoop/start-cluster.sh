...
docker build -f docker/base/Dockerfile -t ccosming/hadoop-cluster-base:latest docker/base

# create master node hadoop cluster docker image
docker build -f docker/master/Dockerfile -t ccosming/hadoop-cluster-master:latest docker/master
